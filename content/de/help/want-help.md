...
<div class="form-help container mx-auto py-10">
  ...
  <input class="inp block py-2 w-full rounded-md border dark:border-transparent pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-m" type="name" id="fname" name="fname" placeholder="Name"><br>
