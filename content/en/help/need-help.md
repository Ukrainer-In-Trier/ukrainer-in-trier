...
<div class="form-help container mx-auto py-10">
  ...
  <input class="inp block w-full rounded-md py-2 border dark:border-transparent pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-m" type="email" id="email" name="email" placeholder="example@email.com"><br>
