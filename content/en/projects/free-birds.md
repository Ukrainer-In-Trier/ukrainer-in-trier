...
<div class='m-0 bg-fixed bg-cover'>
    <div style='background-color: rgba(220, 38, 38, 0.8)' class='py-8'>
        ...
        <h2 class='text-white text-3xl font-bold pt-4'>Creative team</h2>
        <h2 class='uppercase text-4xl text-white font-bold py-4 mb-4'>
"FREE BIRDS"</h2> 
        <p class='text-white py-4 text-xl text-justify'>The mysterious ancient Trier attracts talented people, binds and unites them. That's right, previously unknown people - were able to become a single incredible team. Music, dancing, singing, creative skills - everything is in abundance. Thanks to the union, we manage to introduce Europeans to Ukrainian culture and folklore.</p>
    </div>
...
singer</p>
   ...
   <div class='relative'>
        ...
        <div class='absolute w-64 h-16 bg-white dark:bg-gray-800 bottom-0'>
            <h4 class='text-2xl p-2 '>group "NOVA" </h4>
            <p class='px-2 pb-2'>
Insta: @_nova_nova</p>
        </div>
    </div>
     <div class='relative'>
        ...
        <div class='absolute w-64 h-16 bg-white dark:bg-gray-800 bottom-0'>
            <h4 class='text-2xl p-2 '>Maria and Valeria </h4>
            <p class='px-2 pb-2'>
choreographers</p>
        </div>
    </div>
