...
<div class="form-help container mx-auto py-10">
  ...
  <textarea type="text" id="text" name="text" placeholder="I can ..." rows="5" cols="28" class="inp textarea__help mt-4 pt-4 block w-full rounded-md border dark:border-transparent pl-7 pr-12 focus:border-indigo-500 dark:text-black focus:ring-indigo-500 sm:text-m""></textarea><br><br>
